...
```bash
bash <(curl -sL [https://raw.githubusercontent.com/playfulsoul/vps-monitor-pro/main/vps-monitor-pro.sh](https://raw.githubusercontent.com/playfulsoul/vps-monitor-pro/main/vps-monitor-pro.sh))
